...
import { 
  Brain, Search, Filter, Plus, Tag, Calendar, 
...
export default function MemoryView() {
  ...
  const filteredMemories = memories.filter(memory => {
    const matchesSearch = memory.key.toLowerCase().includes(searchQuery.toLowerCase()) ||
  ...
  const categories = ['fact', 'decision', 'preference', 'context', 'lesson', 'system'] as MemoryCategory[];
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400">{memories.length} entries · Knowledge base</p>
              </div>
            </div>
      ...
      {selectedMemory && (
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className={cn(
              'text-xs px-2 py-0.5 rounded-full',
              getMemoryCategoryColor(selectedMemory.category).bg,
              getMemoryCategoryColor(selectedMemory.category).text
            )}>
          ...
          <div className="space-y-3 text-sm">
            <div className="flex items-center justify-between">
              ...
              <span>{selectedMemory.tags.join(', ') || 'Unknown'}</span>
            </div>
            <div className="flex items-center justify-between">
          ...
          <div className="flex gap-3 mt-8">
            ...
            <button className="flex-1 py-2 text-sm text-center text-red-400 border border-red-500/30 hover:bg-red-500/10 rounded-lg transition-colors">
              Delete
            </button>
          </div>
        </motion.div>
